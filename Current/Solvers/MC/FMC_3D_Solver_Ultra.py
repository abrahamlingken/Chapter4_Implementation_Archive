...
def solve_case(case_key, output_dir='MC3D_Results', n_photons_override=None):
    ...
    print("  - Exact voxel track-length tally")
    print("  - Raw benchmark field (no post-processing)")
    print("="*70)
...
def main():
    ...
    photon_text = (
        ...
        else "1,000,000,000 (1 Billion)"
    )
    print(f"  Photon count:     {photon_text}")
    print("  Tally:            Exact voxel track-length")
    print("  Output:           Raw benchmark field")
    ...
    for case_key in cases:
        G_field = solve_case(case_key, args.output_dir, n_photons_override=args.n_photons)
    ...
    print("\nThese are raw ultra-statistics benchmarks for PINN validation.")
